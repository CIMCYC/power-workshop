...
lex_high  <- rnorm(10, mean = 700, sd = 200) # generate data for high frequency words
lex_low <- rnorm(10, mean = 750, sd = 200) # generate data for low frequency words
...
knitr::include_graphics("for_loop.png")
```
